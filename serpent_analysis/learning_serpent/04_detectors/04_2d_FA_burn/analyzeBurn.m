...
if (exist("./04_2d_pwr_gd_FA_burn_res.m", "file") != 2)
  disp("Could not find 04_2d_pwr_gd_FA_burn_res.m from current folder! Cannot do analysis.")
  exit()
endif

## Check that the depletion output file exists

if (exist("./04_2d_pwr_gd_FA_burn_dep.m", "file") != 2)
  disp("Could not find 04_2d_pwr_gd_FA_burn_dep.m from current folder! Cannot do analysis.")
  exit()
endif

## Run both of the files to bring the results to workspace

run 04_2d_pwr_gd_FA_burn_res.m;
run 04_2d_pwr_gd_FA_burn_dep.m;
