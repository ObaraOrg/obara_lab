...
def plot_keff(cut: int, no_err_bars: bool, bw: bool, input_folders: Tuple[str, ...]) -> None:
    ...
    plt.legend(loc="best", fontsize=15, edgecolor='black',bbox_to_anchor=(0.30, 1))
    #plt.legend(loc="upper center", bbox_to_anchor=(0.5, -0.05), fontsize=16, edgecolor='black')
