...
def _calc_pos(org1, org2, lim1, lim2):
    ...
    if pos == 0 or pos == 1:
        raise ValueError(
            "When pos=None, at least one origin should be "
...
def yaxes(ax1, org1, ax2, org2, pos=None):
    ...
    if pos is None:
        ...
        try:
            ...
            raise TypeError("'ax1' and 'ax2' should be Axes objects of " "matplotlib.")

        # Calculate the position
        pos = _calc_pos(org1, org2, lim1, lim2)

    elif pos <= 0 or pos >= 1:
        raise ValueError("The position to align the origins should be " "0 < pos < 1.")

    # Apply the new ranges
    yaxis(ax1, org1, pos, True)
    yaxis(ax2, org2, pos, True)
...
def xaxes(ax1, org1, ax2, org2, pos=None):
    ...
    # Apply the new ranges
    xaxis(ax1, org1, pos, True)
    xaxis(ax2, org2, pos, True)
