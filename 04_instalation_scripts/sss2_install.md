...
**NOTE:** In case you're not familiar with the linux environment or are a 
bit rusty, use the TSUBAME Intro to linux tutorial PDF found in the folder.
...
## Perform benchmark calc. (recomended, see if you compiled the code well)
